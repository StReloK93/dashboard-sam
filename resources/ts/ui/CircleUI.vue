<template>
   <aside
      ...
      class="xl:w-[70px] xl:h-[70px] w-[56px] h-[56px] bg-zinc-900 text-base neomorph rounded-full gap-1 border-2 border-transparent relative flex justify-center items-center flex-col"
   >
      <slot></slot>
