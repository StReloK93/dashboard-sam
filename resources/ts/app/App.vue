<template>
    <section :class="[setting.excavators ? 'xl:grid-rows-[38px,35px,1fr,80px] lg:grid-rows-[31px,30px,1fr,135px,70px] grid-rows-[31px,30px,1fr,135px,80px]' : 'xl:grid-rows-[38px,35px,1fr] grid-rows-[31px,30px,1fr]']"
