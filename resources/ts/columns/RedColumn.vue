   ...
   <main class="border-r border-zinc-800 flex flex-col">
      ...
      <aside class="red-scroll overflow-y-auto flex-grow scroll overflow-x-hidden relative">
         ...
         <main class="absolute inset-0">
            ...
            <TransportProcessGroup v-if="envSettings.gusaks" grid-cols="grid-cols-2" title="Suv olish maydonida" color="sky" scroll-color="sky-scroll" :data="waterTrucks.inGUSAK" />
         </main>
      </aside>
   </main>
</template>
